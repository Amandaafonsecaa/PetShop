...
CREATE TABLE Tutor (
	...
	created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, -- Adicione esta linha
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP -- E esta linha
...
INSERT INTO Animal (nome, especie, raca, peso, sexo, data_nascimento, id_tutor) VALUES
('Rex', 'Cachorro', 'Labrador', 25.5, 'M', '2020-03-15', 1),
('Miau', 'Gato', 'Siamês', 4.2, 'F', '2022-01-20', 2),
('Buddy', 'Cachorro', 'Golden Retriever', 30.0, 'M', '2019-11-01', 1),
('Luna', 'Gato', 'Persa', 3.5, 'F', '2023-05-10', 3);
...
INSERT INTO Consulta (id_animal, data_hora, id_funcionario, diagnostico, preco) VALUES
